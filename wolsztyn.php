...
<head>
  ...
  <title>Wolsztyn - skansen i parowozownia</title>
...
<div class="menu-btn">
  ...
  <span class="text" id="text1">Wolsztyn - skansen i parowozownia</span>
  ...
  <div class="container-category">
    ...
    <div class="box">
      ...
      $wynik = $conn->query("SELECT * FROM galeria WHERE kategoria = 'wolsztyn' AND id BETWEEN 1 AND 7");
      ...
      $wynikA = $conn->query("SELECT * FROM galeria WHERE kategoria = 'wolsztyn' AND id BETWEEN 8 AND 13");
      ...
      $wynikA = $conn->query("SELECT * FROM galeria WHERE kategoria = 'wolsztyn' AND id BETWEEN 14 AND 18");
